...
import com.zz.generateproto.protostuff.runtime.ArrayObject;
import com.zz.generateproto.protostuff.runtime.DynamicObject;
import com.zz.generateproto.protostuff.runtime.Generators;
...
public class ArrayObjectTest {
	...
	public void testBoolean() throws Exception {
		testClass(BooleanArrayObjectClass.class, new Boolean[] { Boolean.FALSE, Boolean.TRUE }, Boolean.class,
				"booleanValue");
	}
	...
	private <T> void testClass(Class<T> schemaCls, Object expectedArray, Class<?> itemClass, String fieldName)
			throws Exception {
